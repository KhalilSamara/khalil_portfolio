...
<template>
  <div class="card">
    ...
    <p class="mb-5 text-sm text-gray-600 dark:text-night-200" v-html="resume.profile.aboutMe"></p>
    <!-- <div class="my-5 border-t border-dashed border-gray-200"></div> -->
    <ul class="inline-flex space-x-2 font-semibold rtl:space-x-reverse">
      <!-- Menu -->
