...
const setDocumentDirection = () => {
  document.documentElement.setAttribute('dir', locale.value === 'ar-JO' ? 'rtl' : 'ltr');
};
onMounted(() => {
  /** Load theme */
...
// Watch for locale changes to update the direction dynamically
watch(locale, setDocumentDirection);
</script>
